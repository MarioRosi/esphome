...
AUTO_LOAD = ["pcf8574", "ethernet", "uart"]
...
async def to_code(config):
    if (
        CONF_RLS_GROUPS in config
        and CONF_RLS_TIMES in config
        and CONF_RLS_SHUTTERS in config
    ):
        rlstimes = []
